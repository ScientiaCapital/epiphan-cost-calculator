...
import { SdrActions } from "@/components/sdr-actions";
    ...
    <div className="min-h-screen bg-[#fafafa] text-[#424242] leading-normal font-sans">
      ...
      <div className="max-w-[1200px] mx-auto p-6">
        ...
        <div className="grid grid-cols-[340px_1fr] max-[900px]:grid-cols-1 gap-6 items-start">
          ...
          {/* Right: Results — full cost model (Higher Ed / Community College) or
              fit-first view (Live Events / Corporate / Broadcast). */}
          <div>
            ...
            <SdrActions inputs={inputs} results={results} />
