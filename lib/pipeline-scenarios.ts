...
//     aging third-party capture appliances -> "7"; brand-new build -> "3"/"5").
...
export const PIPELINE_SCENARIOS: PipelineScenario[] = [
  {
    ...
    rep: "[redacted-rep]",
    product: "Pearl Nexus",
    pain: "Replacing a fleet of 199 aging third-party capture appliances that integrate poorly with their room-control systems.",
    roomsBasis: "Call: manages a fleet of 199 aging third-party capture appliances.",
  ...
  },
  {
    ...
    rep: "[redacted-rep]",
    product: "Pearl Nexus + Epiphan Edge",
    pain: "Standardizing engineering-school classrooms on Pearl Nexus with their existing video platform.",
  ...
  },
  {
    ...
    rep: "[redacted-rep]",
    product: "Pearl Nexus",
    pain: "Migrating off a legacy capture platform to a hardware-agnostic solution; contract expires in two years.",
  ...
  },
  {
    ...
    rep: "[redacted-rep]",
    product: "Pearl Nexus + Epiphan Edge",
    pain: "Replacing improvised meeting-room capture with one-touch capture; 80 rooms this summer, 300 over three years.",
  ...
  },
  {
    ...
    pain: "Replacing legacy first-party capture hardware across an extensive AV estate.",
    roomsBasis: "Estimate: large institution replacing legacy capture hardware (no unit count stated).",
  ...
  },
  {
    ...
    pain: "Replacing failing legacy scribe recorders; rack space favors the Nexus form factor.",
  ...
  },
  {
    ...
    pain: "Replacing 20 to 30 aging capture units a year; projecting roughly 40 Pearl Nexus by 2029.",
  ...
  },
  {
    ...
    rep: "[redacted-rep]",
    product: "EC20 PTZ Camera",
    pain: "Classroom upgrade project adding auto-tracking cameras with their existing video platform.",
  ...
  },
  {
    ...
    rep: "[redacted-rep]",
    product: "EC20 PTZ Camera",
    pain: "Evaluating AI-tracking cameras to replace aging third-party units, recording to their existing video platform.",
